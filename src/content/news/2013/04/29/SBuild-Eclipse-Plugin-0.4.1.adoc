...
e.g. by writing in the https://sbuild.tototec.de/sbuild/projects/sbuild/boards[forums] or by creating a https://sbuild.tototec.de/sbuild/projects/sbuild/issues/new[ticket].
